...
function initialWall(){
    document.getElementById("left_wall").addEventListener("mouseover", hitTheTopWall);
    document.getElementById("right_wall").addEventListener("mouseover", hitTheTopWall);
    document.getElementById("top_wall").addEventListener("mouseover", hitTheTopWall);
    document.getElementById("center_wall").addEventListener("mouseover", hitTheCenterWall);
    document.getElementById("bottom_wall").addEventListener("mouseover", hitTheBottomWall);
    var t = document.getElementsByClassName("wall");
    for (var i = 0; i < t.length; ++i){
        t[i].addEventListener("mouseleave", initialGame);
    }
}

//初始化迷宫
function initialMaze(){
    document.getElementById("maze").addEventListener("mouseover", inMaze);
    document.getElementById("maze").addEventListener("mouseleave", outMaze);
}

//初始化开始块
function initialStart(){
    document.getElementById("start").addEventListener("mouseover", onStart);
}

//初始化结束块
function initialEnd(){
    document.getElementById("end").addEventListener("mouseover", onEnd);
    document.getElementById("end").addEventListener("mouseleave", initialGame);
}
